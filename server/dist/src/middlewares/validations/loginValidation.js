...
var loginValidation = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var validationErrors, _a, email, password, validatedData, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, loginSchema.validate({ email: email, password: password }, { stripUnknown: true, abortEarly: false })];
            case 2:
