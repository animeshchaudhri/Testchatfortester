...
var resetPassSchema = yup.object().shape({
    password: yup
        .string()
        .trim()
 ...
 */
var resetPassValidation = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var validationErrors, _a, token, password, validatedData, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, resetPassSchema.validate({ password: password, token: token }, { stripUnknown: true, abortEarly: false })];
            case 2:
...
exports.default = resetPassValidation;
