 ...
 */
var generateAccessTokenAndRefreshToken = function (props) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, accessToken, refreshToken;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                payload = props.payload;
                accessToken = jsonwebtoken_1.default.sign({ data: payload }, jwtOption_1.jwtConfig.ACCESS_TOKEN.secret, {
                    expiresIn: jwtOption_1.jwtConfig.ACCESS_TOKEN.expiry,
                });
                refreshToken = jsonwebtoken_1.default.sign({ data: payload }, jwtOption_1.jwtConfig.REFRESH_TOKEN.secret, {
                    expiresIn: jwtOption_1.jwtConfig.REFRESH_TOKEN.expiry,
                });
                // Store refresh token in user account
                return [4 /*yield*/, prismadb_1.default.account.upsert({
                        where: { id: payload.id },
